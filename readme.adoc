...
| Linux
| https://aur.archlinux.org/packages/gcg/[ArchLinux (AUR)]
a|
[source]
----
yay -S gcg
...
| MacOS
| https://github.com/ldez/homebrew-tap[Homebrew Taps]
a|
[source,bash]
----
brew tap ldez/tap
...
| Windows
| https://github.com/ldez/scoop-bucket[Scoop Bucket]
a|
[source,bash]
----
...
| all
| https://github.com/ldez/gcg/releases[Binaries]
a|
